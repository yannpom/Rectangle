...
class Action6: WindowCalculation, RepeatedExecutionsCalculationDouble {
    ...
    func calculateFirstRect(_ window: Window, lastAction: RectangleAction?, visibleFrameOfScreen: CGRect, action: WindowAction) -> RectResult {
        ...
        oneQuarterRect.origin.x = visibleFrameOfScreen.minX + ceil((1.0-0.26) * visibleFrameOfScreen.width)
